  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="https://images5.alphacoders.com/575/thumb-1920-575881.jpg" alt="Los Angeles" style="width:100%; ">
        <div class="carousel-caption">
          <h3>New Zealand</h3>
          <p>NZ is always so much fun!</p>
...
<div class="row">
  ...
  <a href="Destination_1_hotel_1.blade.php "><img src="https://wallpaperaccess.com/full/84586.jpg" class="image"></a>
  <div class="caption middle">
                      ...
                      <div><i class="fa fa-tags"> &nbsp; Children : $1500</i></div>
                            ...
                            <hr style="border-top: 1px solid red;">
                            <center><a class="btn btn-primary" href="Destination_1_hotel_1.blade.php" role="button">Book Now</a></center>
                        </div>
  </div>
  </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href="Destination_2_hotel_2.blade.php  "><img src="https://i.pinimg.com/originals/c1/e0/00/c1e000337f54faad027ee28557490fe5.jpg" class="image"></a>
  <div class="caption middle">
                      ...
                      <div><i class="fa fa-tags"> &nbsp; Children : $1300</i></div>
                            ...
                            <p style="word-spacing: 10px;">20 Hotels   .24 cars   .20+ Tours </p>
                            <hr style="border-top: 1px solid red;">
                            <center><a class="btn btn-primary" href="Destination_1_hotel_2.blade.php" role="button">Book Now</a></center>
                        </div>
  </div>
  </div>
  ...
  <div class="caption middle">
                            ...
                            <div> <span class="fas fa-plane">   New Zealand Marriott Marquis</span></div><br>
                            <div><span class="fas fa-star color-red"></span>
                            <span class="fa fa-star color-yellow"></span>
                          <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
                      ...
                      <div><i class="fa fa-tags"> &nbsp; Children : $1000</i></div>
                            ...
                            <p style="word-spacing: 10px;">20 Hotels   .24 cars   .20+ Tours </p>
                            <hr style="border-top: 1px solid red;">
                            <center><a class="btn btn-primary" href="Destination_1_hotel_3.blade.php" role="button">Book Now</a></center>
                        </div>
  </div>
  </div>
  ...
  <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href=" Destination_4_hotel_4.blade.php "><img src="https://i.pinimg.com/originals/c1/e0/00/c1e000337f54faad027ee28557490fe5.jpg" class="image"></a>
  <div class="caption middle">
                      ...
                      <div><i class="fa fa-tags"> &nbsp; Children : $1200</i></div>
                            ...
                            <p style="word-spacing: 10px;">20 Hotels   .24 cars   .20+ Tours </p>
                            <hr style="border-top: 1px solid red;">
                            <center><a class="btn btn-primary" href="Destination_1_hotel_4.blade.php" role="button">Book Now</a></center>
                        </div>
  </div>
  </div>
